...
/*!
    ...
    \file
     \section sdhlibrary_cpp_sdh_demo_radians_general General file information
     ...
     \brief
       ...
       with "pose" controller type (coordinated position control), commanding in radians.
       See \ref demo_radians__help__ "__help__" and online help ("-h" or "--help") for available options.
     ...
     \section sdhlibrary_cpp_sdh_demo_radians_copyright Copyright
     ...
     \internal
       ...
       \subsection sdhlibrary_cpp_sdh_demo_radians_details SVN related, detailed file specific information:
         $LastChangedBy: Osswald2 $
         $LastChangedDate: 2013-11-27 16:12:49 +0100 (Wed, 27 Nov 2013) $
         \par SVN file revision:
           $Id: demo-radians.cpp 11045 2013-11-27 15:12:49Z Osswald2 $

     \subsection sdhlibrary_cpp_sdh_demo_radians_changelog Changelog of this file:
         \include demo-radians.cpp.log
...
/*!
    \anchor sdhlibrary_cpp_demo_radians_cpp_vars
    \name   Some informative variables

    @{
*/
//! \anchor demo_radians__help__
char const* __help__      =
...
//  end of doxygen name group sdhlibrary_cpp_demo_radians_cpp_vars
//  @}
...
int main( int argc, char** argv )
{
    ...
    options.Parse( argc, argv, __help__, "demo-radians", __version__, cSDH::GetLibraryName(), cSDH::GetLibraryRelease() );
    //
    //---------------------
    ...
    try
    {
        ...
        cSDH hand( true, options.use_fahrenheit, options.debug_level );
        ...
        hand.SetAxisTargetVelocity( hand.All, 40.0*M_PI/180.0 );
        ...
        fta[1] -= 10.0*M_PI/180.0;
        fta[2] -= 10.0*M_PI/180.0;
    ...
    {
        std::cerr << "demo-radians main(): An exception was caught: " << e->what() << "\n";
        delete e;
    }
}
//----------------------------------------------------------------------
