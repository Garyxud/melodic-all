# -*- coding: utf-8 -*-
#
# rocon_launch documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_launchdoc'
...
latex_documents = [
  ('index', 'rocon_launch.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_launch', u'rocon_launch Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_launch', u'rocon_launch Documentation',
   u'Daniel Stonier', 'rocon_launch', 'One line description of project.',
   'Miscellaneous'),
]
