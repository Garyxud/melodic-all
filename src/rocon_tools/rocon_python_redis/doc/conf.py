# -*- coding: utf-8 -*-
#
# rocon_python_redis documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_python_redisdoc'
...
latex_documents = [
  ('index', 'rocon_python_redis.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_python_redis', u'rocon_python_redis Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_python_redis', u'rocon_python_redis Documentation',
   u'Daniel Stonier', 'rocon_python_redis', 'One line description of project.',
   'Miscellaneous'),
]
