# -*- coding: utf-8 -*-
#
# rocon_python_utils documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_python_utilsdoc'
...
latex_documents = [
  ('index', 'rocon_python_utils.tex', u'rocon\\_interactions Documentation',
...
man_pages = [
    ('index', 'rocon_python_utils', u'rocon_python_utils Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_python_utils', u'rocon_python_utils Documentation',
   u'Daniel Stonier', 'rocon_python_utils', 'One line description of project.',
   'Miscellaneous'),
]
