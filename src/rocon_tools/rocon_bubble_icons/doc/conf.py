# -*- coding: utf-8 -*-
#
# rocon_bubble_icons documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_bubble_iconsdoc'
...
latex_documents = [
  ('index', 'rocon_bubble_icons.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_bubble_icons', u'rocon_bubble_icons Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_bubble_icons', u'rocon_bubble_icons Documentation',
   u'Daniel Stonier', 'rocon_bubble_icons', 'One line description of project.',
   'Miscellaneous'),
]
