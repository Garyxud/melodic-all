# -*- coding: utf-8 -*-
#
# rocon_master_info documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_master_infodoc'
...
latex_documents = [
  ('index', 'rocon_master_info.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_master_info', u'rocon_master_info Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_master_info', u'rocon_master_info Documentation',
   u'Daniel Stonier', 'rocon_master_info', 'One line description of project.',
   'Miscellaneous'),
]
