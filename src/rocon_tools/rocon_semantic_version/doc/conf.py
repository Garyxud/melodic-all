# -*- coding: utf-8 -*-
#
# rocon_semantic_version documentation build configuration file, created by
...
project = u'rocon_semantic_version'
...
htmlhelp_basename = 'rocon_semantic_versiondoc'
...
latex_documents = [
  ('index', 'rocon_semantic_version.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_semantic_version', u'rocon_semantic_version Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_semantic_version', u'rocon_semantic_version Documentation',
   u'Daniel Stonier', 'rocon_semantic_version', 'One line description of project.',
   'Miscellaneous'),
]
