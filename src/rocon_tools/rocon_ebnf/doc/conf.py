# -*- coding: utf-8 -*-
#
# rocon_ebnf documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_ebnfdoc'
...
latex_documents = [
  ('index', 'rocon_ebnf.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_ebnf', u'rocon_ebnf Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_ebnf', u'rocon_ebnf Documentation',
   u'Daniel Stonier', 'rocon_ebnf', 'One line description of project.',
   'Miscellaneous'),
]
