# -*- coding: utf-8 -*-
#
# rocon_console documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_consoledoc'
...
latex_documents = [
  ('index', 'rocon_console.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_console', u'rocon_console Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_console', u'rocon_console Documentation',
   u'Daniel Stonier', 'rocon_console', 'One line description of project.',
   'Miscellaneous'),
]
