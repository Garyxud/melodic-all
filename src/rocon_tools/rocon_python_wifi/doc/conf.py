# -*- coding: utf-8 -*-
#
# rocon_python_wifi documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_python_wifidoc'
...
latex_documents = [
  ('index', 'rocon_python_wifi.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_python_wifi', u'rocon_python_wifi Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_python_wifi', u'rocon_python_wifi Documentation',
   u'Daniel Stonier', 'rocon_python_wifi', 'One line description of project.',
   'Miscellaneous'),
]
