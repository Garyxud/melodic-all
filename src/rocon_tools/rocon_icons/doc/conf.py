# -*- coding: utf-8 -*-
#
# rocon_icons documentation build configuration file, created by
...
htmlhelp_basename = 'rocon_iconsdoc'
...
latex_documents = [
  ('index', 'rocon_icons.tex', u'rocon\\_bubble\\_icons Documentation',
...
man_pages = [
    ('index', 'rocon_icons', u'rocon_icons Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon_icons', u'rocon_icons Documentation',
   u'Daniel Stonier', 'rocon_icons', 'One line description of project.',
   'Miscellaneous'),
]
